...
export class MyApp {
  rootPage = FirstRunPage; /* page lancée par défaut */
  ...
  ]; /* Tableau d'éléments - ce sont les items de notre menu */
  ...
  constructor(
    ...
    platform.ready().then(() => {
      ...
      this.statusBar.styleDefault(); /* StatusBar prendra la valeur par défaut : la barre du téléphone en haut */
